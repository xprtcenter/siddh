...
export default function MobileHeaderUpdated() {
	const [open, setOpen] = useState(false);
	const [showMegaMenu, setShowMegaMenu] = useState(false);

	return (
		<div>
			<div className="sm:hidden bg-green dark:bg-dark">
				<div className="container mx-auto">
					<div className="relative -mx-4 flex items-center justify-between">
						...
						<div className="flex w-full items-center justify-evenly px-4 z-1000">
							<div>
								<button
								...
								>
									<span className="relative my-[6px] block h-[2px] w-[30px] bg-primaryOrange dark:bg-primaryBlue"></span>
									<span className="relative my-[6px] block h-[2px] w-[30px] bg-primaryOrange dark:bg-white"></span>
									<span className="relative my-[6px] block h-[2px] w-[30px] bg-primaryOrange dark:bg-white"></span>
								</button>
								<nav
									id="navbarCollapse"
								...
								>
									<ul className="block lg:flex z-1000">
										...
										<li>
											<div className=" justify-center gap-3 pr-16 sm:flex lg:pr-0">
												<a
													href="#"
